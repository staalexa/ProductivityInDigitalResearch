...
\begin{solution}
    Green:
    \begin{enumerate}
        \item \mintinline{text}{/home/prof/Pictures}
        \item \mintinline{text}{../prof/Pictures}
        \item \mintinline{text}{~/Pictures}
    \end{enumerate}
    Red:
    \begin{enumerate}
...
\begin{exercise}[subtitle=Viewing and editing files with \texttt{cat}, \texttt{less} and \texttt{nano}]
    Read through the \mintinline{text}{man} page for \mintinline{text}{cp} and \mintinline{text}{mv}.
    \begin{enumerate}
