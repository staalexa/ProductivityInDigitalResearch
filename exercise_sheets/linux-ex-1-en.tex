...
In short: open PowerShell as administrator and run the command \mintinline{text}{wsl --install}. Once its finished, install a Linux distribution (e.g. Ubuntu 24.04) with \mintinline{text}{wsl --install Ubuntu-24.04}.
